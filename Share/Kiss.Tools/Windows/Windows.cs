...
using Kiss.Tools.Hardware;
using Microsoft.Win32;

namespace Kiss.Tools.Windows
{
    /// <summary>
    /// Windows系统的系列方法
    /// </summary>
    public static class Windows
    {
        ...
        public static string RunApp(string filename, string arguments, bool recordLog)
        {
            try
            {
                ...
                proc.Start();
                var sr = new StreamReader(proc.StandardOutput.BaseStream, Encoding.Default);
    ...
    public class WindowsServer
    {
        ...
        /// 获取实例
        /// </summary>
        public static WindowsServer Instance => _instance ?? (_instance = new WindowsServer());
