    ...
    public static class ImageUtilities
    {
        ...
        public static void ZoomAuto(this Stream fromFile, string savePath, double targetWidth, double targetHeight, string watermarkText, string watermarkImage)
        {
            ...
            if ((initImage.Width <= targetWidth) && (initImage.Height <= targetHeight))
            {
                ...
                if (watermarkText != "")
                {
                    var gWater = Graphics.FromImage(initImage);
                ...
                if (watermarkImage != "")
                {
                    ...
                    {
                        var wrImage = Image.FromFile(watermarkImage);
        ...
        public static Bitmap CutImage(this Bitmap b, Rectangle rec)
        {
            ...
            try
            {
                ...
                var g = Graphics.FromImage(bmppOut);
        ...
        public static bool CompressImage(string sFile, string dFile, byte quality = 90, int size = 1024, bool sfsc = true)
        {
            ...
            var dHeight = iSource.Height;
            var dWidth = iSource.Width;
            int sW, sH;
            //按比例缩放
            ...
            var bmpp = new Bitmap(dWidth, dHeight);
            var g = Graphics.FromImage(bmpp);
            ...
            var eParam = new EncoderParameter(Encoder.Quality, new long[] { quality });
            ep.Param[0] = eParam;
            try
            {
        ...
        public static bool CompressImage(Stream src, Stream dest, byte quality = 90, int size = 1024, bool sfsc = true)
        {
            ...
            var iSource = Image.FromStream(src);
            var tFormat = iSource.RawFormat;
            var dHeight = iSource.Height;
            var dWidth = iSource.Width;
            int sW, sH;
        ...
        {
            var bmp = new Bitmap(width, height); //初始化一个记录经过处理后的图片对象
