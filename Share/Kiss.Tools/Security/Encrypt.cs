...
namespace Kiss.Tools.Security
{
    ...
    public static class Encrypt
    {
        ...
        /// <summary>
        /// 加密密钥，默认取“KissTools”的MD5值
        /// </summary>
        public static string DefaultEncryptKey = "KissTool".MDString2();
        ...
        {
            var frde = new FileStream(outputPath, FileMode.Create);
            var defr = AESDecryptStream(input, Default_AES_Key);
